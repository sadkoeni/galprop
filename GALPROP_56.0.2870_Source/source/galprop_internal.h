...
double eprop(double,double,double,double,double,double,double,double,double,double,const string&);//IMOS20061030
...
double nucleon_loss(int,double,double,double,double,double,        // nucleon
...
int kinematic(int, int, double, double&, double&, double&, double&, double&, double&, int);
...
double nHIold(double, double);
double nH2old(double, double);
double nH2old(double, double, double);//AWS20090616
...
double nH_av(double x, double y, double z, double dz, double dzz, double(*)(const double, const double)); //IMOS20080114
double nH_av(double x, double y, double z, double dz, double dzz, double(*)(const double, const double, const double)); //IMOS20080114
double nH_av(double x, double y, double z, double dz, double dzz, double xCO, double(*)(const double, const double, const double, const double));                      //AWS20090616
double nH_av_lb(double, double, double, double, double, double, double, double(*)(const double, const double, const double)); //IMOS20080114
double nH_av_lb(double, double, double, double, double, double, double, double,double(*)(const double, const double, const double, const double)); //AWS20090616

...
class HealpixBaseExtended : public Healpix_Base {
   ...
   public:
      HealpixBaseExtended(): Healpix_Base() {}
      HealpixBaseExtended(int order, Healpix_Ordering_Scheme scheme): Healpix_Base(order, scheme) {}
      HealpixBaseExtended(int nside, Healpix_Ordering_Scheme scheme, const nside_dummy): Healpix_Base(nside, scheme, SET_NSIDE) {}

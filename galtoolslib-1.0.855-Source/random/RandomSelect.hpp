...
#define RANDOMLIB_RANDOMSELECT_HPP "$Id: ff1a15d0430de63aecffbebb972ba0cbfeba598e $"
...
namespace RandomLib {
  ...
  public:
     ...
     * - \a WeightType integer, \a NumericType integer with
     *   digits(\a NumericType) >= digits(\a WeightType)

...
utl::ErrorLogger::GetInstance().Log(severity, __func__, __FILE__, __LINE__, message)

/// Brief message logging macro - always do \e terse logging
#define LOG_TERSE_MESSAGE_(severity, message) \
utl::ErrorLogger::GetInstance().Log(severity, __func__, __FILE__,  __LINE__, message, utl::ErrorLogger::eTerse)

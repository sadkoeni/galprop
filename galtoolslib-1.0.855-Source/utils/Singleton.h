...
namespace utl {
  ...
  public:
    ...
    LeakingSingleton(const LeakingSingleton&) = delete;
    LeakingSingleton(LeakingSingleton&&) = delete;
    LeakingSingleton& operator=(const LeakingSingleton&) = delete;
    LeakingSingleton& operator=(LeakingSingleton&&) = delete;
  ...
  template<class T>
    T* LeakingSingleton<T>::fgInstance = nullptr;

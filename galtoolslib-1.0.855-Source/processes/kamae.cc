...
valarray<double> processes::kamae_gamma_param_nd(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_gamma_param_diff(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_gamma_param_delta(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_gamma_param_res(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_elec_param_nd(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_elec_param_diff(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
void processes::kamae_elec_param_delta(double Tp, double* param_c) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_elec_param_res(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_posi_param_nd(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_posi_param_diff(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_posi_param_delta(double Tp) {
...
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
valarray<double> processes::kamae_posi_param_res(double Tp) {
...
//**.****!****.****!****.****!****.****!****.****!****.****!****.****!****.****!
double processes::kamae_nd(double E, double Tp, valarray<double> param_a, int particle) {
...
// return differential cross section dsigma/dlogE in mbarn/GeV 
//**.****!****.****!****.****!****.****!****.****!****.****!****.****!****.****!
double processes::kamae_diff(double E, double Tp, valarray<double> param_b) {
...
// return differential cross section dsigma/dlogE in mbarn/GeV 
//**.****!****.****!****.****!****.****!****.****!****.****!****.****!****.****!
double processes::kamae_delta(double E, double Tp, valarray<double> param_c) {
...
// return differential cross section dsigma/dlogE in mbarn/GeV 
//**.****!****.****!****.****!****.****!****.****!****.****!****.****!****.****!
double processes::kamae_res(double E, double Tp, valarray<double> param_d) {

  return processes::kamae_delta(E, Tp, param_d);
...
//**.****!****.****!****.****!****.****!****.****!****.****!****.****!****.****!
double 
processes::kamae(double Esec, double Pp2, int NA11, int NA21, int key, 
  ...
  s_nd = 1.0e-3*processes::kamae_nd(Esec,Tp,params0,key);
  s_diff = 1.0e-3*processes::kamae_diff(Esec,Tp,params1);
  s_delta = 1.0e-3*processes::kamae_delta(Esec,Tp,params2);
  s_res = 1.0e-3*processes::kamae_res(Esec,Tp,params3);

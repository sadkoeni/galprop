...
const char* data_filename[N_DATA_FILES] = {"isotope_cs.dat","nucdata.dat","p_cs_fits.dat","eval_iso_cs.dat"};
...
// The long-lived isotopes listed in "longliv" table are included as stable;
   static const int stable[64][3] = {      // second index changes faster
...
// TODO move this into the declaration of the array and make it static const
...
// ZB.AB; left boundary[][0]: Nn=0(1)28; right boundary[][1]: Np=1(1)28 
    int nb = 29;
    static const float boundary[29][2] = {  // second index changes faster
       {  1.01,  1.04},  {  3.04,  2.08},
       {  3.05,  3.11},  {  6.09,  4.14},
       {  6.10,  5.15},  {  8.13,  6.16},
